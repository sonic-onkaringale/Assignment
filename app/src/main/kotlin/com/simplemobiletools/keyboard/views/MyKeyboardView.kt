    ...
    View(context, attrs, defStyleRes)
{
    ...
    lateinit var mEditorInfo: EditorInfo
    ...
    fun setKeyboardHolder(keyboardHolder: View)
    {
        ...
        val mCustomToolbar = keyboardHolder.custom_toolbar_container


        mCustomToolbar.apply {
            hello_btn.setOnClickListener {
                mOnKeyboardActionListener!!.onText("Hello")
            }
            alternate_input_field_materialEdt.editText?.showSoftInputOnFocus = false

            alternate_input_field_materialEdt.editText?.setOnClickListener {

            }
            complete_btn.setOnClickListener {
                val text_to_paste = alternate_input_field_materialEdt.editText?.text.toString()
                mOnKeyboardActionListener!!.onText(text_to_paste)
            }
